...
class Conchoid(MovingCameraScene):
    ...
    def construct(self):
        ...
        conchoidDescription = Tex("A conchoid is a curve generated using a fixed point, a straight line and a length k")
        ...
        # self.play(FadeOut(VGroup(equations, conchoidEq, explainationB, explainationK)))
        ...
        # ConchoidOfNicomedseEnd = Tex("Conchoid of Nicomedes")
        # ConchoidOfNicomedseEnd.font_size = 90
        # self.play(FadeIn(ConchoidOfNicomedseEnd), FadeOut(curves))
        # self.wait()